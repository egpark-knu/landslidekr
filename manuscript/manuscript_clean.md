...
**Citation note.** This is a submission manuscript. Citations above are verified against their DOIs where listed; the Pack et al. 1998 conference proceedings volume and the in-press WildfireKR reference will be updated with their final publication metadata prior to submission.
...
## Table 4. Lithology-class Monte Carlo parameter bounds (literature-grounded; the single granite-bound adjustment is described in Methods)
